...
class ClassReaderTest {
    ...
    void setUp() throws IOException {
        String file = "target/classes/com/github/std/mtjvm/engine/classloader/ClassReader.class";
    ...
    void thisClass() {
        ...
        assertEquals("com/github/std/mtjvm/engine/classloader/ClassReader", thisClass);
    }
