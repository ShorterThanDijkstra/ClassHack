...
public final class RuntimeVisibleTypeAnnotations implements AttributeInfo {
    private final List<TypeAnno> typeAnnos;

    public RuntimeVisibleTypeAnnotations(List<TypeAnno> typeAnnos) {
    ...
    public static RuntimeVisibleTypeAnnotations parse(InputStream input, ClassFile.ClassFileBuilder metaData) throws IOException {
        ...
        return new RuntimeVisibleTypeAnnotations(typeAnnos);
    }
}