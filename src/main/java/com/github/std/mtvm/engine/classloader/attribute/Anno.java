...
public class Anno {
    ...
    public Anno(String type, List<ElementValuePair> pairs) {
        this.type = type;
        this.pairs = pairs;
    }

    private final static class ElementValuePair {
        private final String name;
        private final ElementValue value;

        public static ElementValuePair parse(InputStream input, ClassFile.ClassFileBuilder metaData) throws IOException {
            ...
            return new ElementValuePair(name, elementValue);
        }
    ...
    public static Anno parse(InputStream input, ClassFile.ClassFileBuilder metaData) throws IOException {
        ...
        List<ElementValuePair> pairs = new ArrayList<>(pairNum);
        for (int i = 0; i < pairNum; i++) {
            pairs.add(ElementValuePair.parse(input, metaData));
        }
