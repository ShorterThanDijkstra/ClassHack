...
public final class Code implements AttributeInfo {
    ...
    public interface Opcode {
        ...
        static Opcode parseFixedLengthOpcode(final byte[] values, final byte value, final int pos) {
            if ((value & 0xff) == 0x32) {
        ...
        static Opcode parse(final byte[] values, final int pos) {
            ...
            if ((value & 0xff) == 0xab) {
                ...
                return new LookupSwitchOpcode("lookupswitch", value, operands, defaultJump, matchOffsetPairs, pos);
            }
            ...
            if ((value & 0xff) == 0xaa) {
                ...
                return new TableSwitchOpcode("stableswitch", value, operands, defaultJump, low, high, offsets, pos);
            }
            if ((value & 0xff) == 0xc4) {
                ...
                return new FixLengthOpcode("wide", value, operands, pos);
            }
            return parseFixedLengthOpcode(values, value, pos);
        }
    ...
    public static class FixLengthOpcode implements Opcode {
        ...
        public FixLengthOpcode(String mnemonic, byte value, byte[] operands, int pos) {
            this.mnemonic = mnemonic;
            this.value = value;
            this.operands = operands;
            this.pos = pos;
        ...
        public FixLengthOpcode(String mnemonic, byte value, int pos) {
            this.mnemonic = mnemonic;
            this.value = value;
            this.pos = pos;
        ...
        private String showWide() {
            ...
            if ((modified & 0xff) == 0x84) {
                ...
                return pos + ":  wide iinc " + index + " " + cst;
            }
