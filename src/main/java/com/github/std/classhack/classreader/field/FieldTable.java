...
public class FieldTable {
    ...
    private static void parseFieldInfoAccessFlags(InputStream input,
        ...
        FieldInfoChecker.checkAccessFlags(bsAccessFlags, metaData);
    ...
    private static void parseFieldInfoName(InputStream input,
        ...
        builder.name = FieldInfoChecker.checkNameIndex(metaData.constantPool, nameIndex);
    }
    ...
    private static void parseFieldInfoDescriptor(InputStream input,
        ...
        builder.descriptor = FieldInfoChecker.checkDescIndex(metaData.constantPool, descIndex);
    }
